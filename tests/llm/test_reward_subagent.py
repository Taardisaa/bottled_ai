...
class ScriptedRewardProvider:
    ...
    def propose(self, context, working_memory):
        self.seen_contexts.append((context, dict(working_memory)))
...
class TestRewardSubagents(unittest.TestCase):
    def test_combat_reward_subagent_can_loop_until_scope_ends(self):
        ...
        provider = ScriptedRewardProvider([
            ...
            RewardCommandProposal("proceed", 0.7, "done_after_gold"),
        ])
        ...
        self.assertEqual([["choose 0"], ["proceed"]], runtime.command_batches)
