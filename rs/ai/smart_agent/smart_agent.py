...
from rs.ai.smart_agent.config import CARD_REMOVAL_PRIORITY_LIST, DESIRED_CARDS_FOR_DECK, HIGH_PRIORITY_UPGRADES, \
    DESIRED_CARDS_FROM_POTIONS, DESIRED_POTIONS
from rs.ai.smart_agent.handlers.event_handler import EventHandler
from rs.ai.smart_agent.handlers.potions_handler import PotionsBossHandler, PotionsEventFightHandler, PotionsEliteHandler
from rs.ai.smart_agent.handlers.shop_purchase_handler import ShopPurchaseHandler
from rs.ai.smart_agent.handlers.upgrade_handler import UpgradeHandler
...
SMART_AGENT: AiStrategy = AiStrategy(
    name='SMART_AGENT',
